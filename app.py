            ...
            if query in name.lower():
                ...
                card_content_children = [
                    ft.Row([
                        ...
                        ft.Text(f"ID: {p_id}", color="grey", size=14),
                ...
                if shiny_exists:
                    ...
                    if shiny_status.get('found_egg'): badges.append(make_method_badge("🥚", "Ägg"))
                    if shiny_status.get('found_evolution'): badges.append(make_method_badge("🧬", "Utveckling"))
                ...
                # --- OM DEN INTE KAN VARA SHINY ÄN ---
                    ...
                    card_content_children.append(
                        ft.Row([
                            ft.Column([
                                ft.Image(src=normal_img_url, width=200, height=160, fit="contain"),
                                ft.Text("Normal", size=12, color="grey"),
                            ], alignment="center")
                        ], alignment="center")
                    )
